...
// const cycle1 = new Cycling([39, -12], 27, 97, 621);
...
class App {
  ...
  _moveToPopup(e) {
    ...
    // workout.click(); // wont exist on local storage retrieved objects
  }
...
5. Re-build the running and cycling objects that come from local storage (fixes the click method error)
